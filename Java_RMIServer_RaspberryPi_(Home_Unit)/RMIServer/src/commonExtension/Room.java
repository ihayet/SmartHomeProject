...
{    
    ...
    public Room(int roomID,String rName,long hID,int nAppliances)
    {
        ...
        applianceArrayBasic = newDatabaseModuleAppliance.getApplianceInformation(hID,numberOfAppliances,roomID,DatabaseParameters.host, DatabaseParameters.dbName, DatabaseParameters.userName, DatabaseParameters.passWord);
    }
}
